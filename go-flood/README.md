...
- `-board`: Board type (`square`, `brick`, `basket-weave`, `waffle`, `triangular-weave`, `two-triangle-weave`, `hex-parallelogram-weave`, `trapezoid-triangle-weave`, `triangle`, `hex`, `rhombitrihexagonal`, `pentagon-cairo`, `pentagon-prismatic`, `pentagon-floret`, `deltoidal-trihexagonal`, `rhombille`, `triakis-triangular`, `kisrhombille`, `tetrakis-square`, `voronoi-jittered`, `voronoi-random`) (default: "square")
